...
class SuferData:
    ...
    def __init__(self, 
                 freesurfer_data_folder,
                 path_base_mri
                ):
        self.freesurfer_data_folder = freesurfer_data_folder
        self.path_base_mri = path_base_mri
        ...
        #criando df final
        self.Data_Strutures = pd.DataFrame(columns=feature_stats)
        
        
        Data_Strutures, data, participants_list_completed_index, participants_list_completed, participants_list_incompleted = collector(self)
    ...
    def struct_stats(self, participant, hemisphere):
        #acessando os dados de estatistica de cada estrutura de um sujeito
    ...
    def vertices_to_df(self, data, participants_list_completed_index):    
    ...
    def monitor(self):
        print(len(self.participants_list_completed))
        print(len(self.participants_list_incompleted))